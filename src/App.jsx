  ...
  return (
    <div className="space-y-2 text-[12px] leading-relaxed">
      <h2 className="text-sm font-bold mb-1">
        Bx – Illustrator, visual artist & designer
      </h2>
      <p>
        This is an “About” window for the Danilarious.art desktop. Each icon on
        this OS will eventually open a world, project, or character series from
        the Danilarious universe.
      </p>
      <p>
        Over time, this window can hold your proper bio, links, and maybe even a
        mini tour of how to explore the site.
      </p>
    </div>
  );
}
